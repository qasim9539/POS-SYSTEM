...
const SettingsPage = () => {
  ...
  return (
    <div className="flex w-full min-h-screen bg-gray-100 font-sans">
      ...
      {/* ========== SIDEBAR ========== */}
      <div className="w-56 min-h-screen bg-[#0f1f45] flex flex-col shrink-0 fixed left-0 top-0 bottom-0 z-50">
        
        {/* Logo */}
        <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
          <div className="w-9 h-9 bg-blue-600 rounded-lg flex items-center justify-center text-white text-lg">📦</div>
          <div>
            <div className="text-white font-bold text-sm">SmartStock</div>
            <div className="text-[10px] text-blue-300">Inventory & Sales System</div>
          </div>
        </div>
        ...
        <nav className="flex-1 py-4 px-2">
          {[
            ...
            <div key={item.label} className="flex items-center gap-3 px-4 py-[10px] text-[#8ea3c3] text-sm rounded-lg mx-1 my-[2px] cursor-pointer hover:bg-white/10 hover:text-white transition-all">
              <span className="text-base">{item.icon}</span>
              <span>{item.label}</span>
            </div>
          ))}
          {/* Active: Settings */}
          <div className="flex items-center gap-3 px-4 py-[10px] text-white text-sm rounded-lg mx-1 my-[2px] cursor-pointer bg-blue-600">
            <span className="text-base">⚙️</span>
            <span>Settings</span>
          </div>
          <div className="flex items-center gap-3 px-4 py-[10px] text-[#8ea3c3] text-sm rounded-lg mx-1 my-[2px] cursor-pointer hover:bg-white/10 hover:text-white transition-all">
        ...
        <div className="px-4 py-4 border-t border-white/10">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <div className="text-white text-xs font-semibold">SmartStock Solutions</div>
              <div className="text-green-400 text-[10px]">Enterprise Plan</div>
            </div>
          </div>
          <div className="flex items-center gap-2 text-[#8ea3c3] text-xs cursor-pointer">
            <span>‹</span>
